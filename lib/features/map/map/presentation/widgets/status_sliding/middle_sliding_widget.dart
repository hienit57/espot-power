            ...
            return GestureDetector(
              onHorizontalDragUpdate: (details) {
                if (details.primaryDelta! > 0) {
                  BlocProvider.of<MapCubit>(context).emitLocationSwipe(false);
                  print('Swiping Right');
                } else if (details.primaryDelta! < 0) {
                  BlocProvider.of<MapCubit>(context).emitLocationSwipe(true);
                    ...
                    if (state.markerSelected?.id == null) ...[
                      ...
                      GestureDetector(
                        ...
                        onTap: () => BlocProvider.of<HomeCubit>(context)
                            .emitIndexTabSelect(0,
                                screenForHome: AllScreenHome.detailsLocation),
                        child: Row(
                          children: [
                            const Padding(
